#ifndef FB2_ELKAN_KMEANS_H
#define FB2_ELKAN_KMEANS_H
...
class FB2_ElkanKmeans : public TriangleInequalityBaseKmeans {
    public:
        FB2_ElkanKmeans() : centerCenterDistDiv2(NULL) {}
        //ElkanKmeans_newbound() : oldcenterCenterDistDiv2(NULL) {}
        virtual ~FB2_ElkanKmeans() { free(); }
        virtual void free();
